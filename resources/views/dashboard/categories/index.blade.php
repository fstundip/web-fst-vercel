...
<div class="card px-4 border-0 shadow-sm">
    ...
    <div>
        ...
        <form action="/dashboard/categories" method="GET" class="mb-3">
        <div class="input-group">
            <input type="text" name="search" class="form-control" placeholder="Cari Category" value="{{ request('search') }}">
        ...
        <table class="table table-striped table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->slug }}</td>
                    <td>
                        <a href="/informasi/{{$item->slug}}" class="badge bg-primary"><svg
                        ...
                        <a href="/dashboard/categories/{{$item->id}}/edit" class="badge bg-warning mx-1"><svg
                                xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
